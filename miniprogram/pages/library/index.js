...
Page({
  data: {
    ...
    iconSearchUrl: (app.globalData.imagePrefix || 'cloud://cloudbase-d9gwy4qvodf85fe69.636c-cloudbase-d9gwy4qvodf85fe69-1427916036/media/images') + '/icons/icon-search.png',
    list: [],
    page: 1,
    pageSize: 20,
    hasMore: false,
